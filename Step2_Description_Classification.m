...
run E:\Projects\SC\Dynamic-3D-Action-Recognition-on-RGB-D-Videos-master\Dynamic-3D-Action-Recognition-on-RGB-D-Videos-master\vl_feat\vlfeat-0.9.20\vlfeat-0.9.20\toolbox\vl_setup.m
disp('Data Loaded');
...
%% Classification and results
    ...
    disp ('Training Time is:');
    disp(TrainingTime);
    disp ('Testing Time is:');
    disp(TestingTime);
    disp ('Training Accuracy is:');
    disp(TrainAC);
    disp ('Accuracy is:');
    disp(TestAC);
